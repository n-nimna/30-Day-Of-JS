...
//5.  Check if 'jargon' is in the sentence 'I hope this course is not full of jargon.'
...
//12.
let Nsentence = 'You cannot end a sentence with because because because is a conjunction';
let start = Nsentence.indexOf('because because because');
let length = 'because because because'.length;
let slicedPhrase = Nsentence.substr(start, length);
