...
let emptyArea = [];
console.log(emptyArea); //output: []

// 2. Array with more than 5 elements
let numberArray = [1, 2, 3, 4, 5, 6, 7];
console.log(numberArray);  //output: [ 1, 2, 3, 4,5, 6, 7]
...
console.log(itCompanies.slice(Math.floor(itCompanies.length / 2), Math.floor(itCompanies.length / 2) + 1)); //output [ 'GOOGLE' ]
