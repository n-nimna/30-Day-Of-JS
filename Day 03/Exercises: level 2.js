...
function triangleArea(base, height) {
  ...
  let length = parseFloat(prompt("Enter length of the rectangle: "));
  let width = parseFloat(prompt("Enter width of the rectangle: "));
  ...
  let equation = prompt("Enter a linear equation (e.g., y = 2x - 2): ");
  linearEquation(equation);
  
  // Slope between two points
  function slopeTwoPoints(x1, y1, x2, y2) {
    const slope = (y2 - y1) / (x2 - x1);
    console.log(`Slope between points (${x1}, ${y1}) and (${x2}, ${y2}): ${slope}`);
  }
  
  // Prompt user for coordinates
  let x1 = parseFloat(prompt("Enter x-coordinate of first point: "));
  let y1 = parseFloat(prompt("Enter y-coordinate of first point: "));
  let x2 = parseFloat(prompt("Enter x-coordinate of second point: "));
  let y2 = parseFloat(prompt("Enter y-coordinate of second point: "));
  ...
  let hours = parseFloat(prompt("Enter number of hours worked: "));
